...
namespace HISSMS
{
    public partial class XtraUserControlMau21KPN : DevExpress.XtraEditors.XtraUserControl
    {
        public XtraUserControlMau21KPN()
        {
            InitializeComponent();
        }
        ...
        {
            string nameRe = "mau_21_khongphannhom.mrt";
