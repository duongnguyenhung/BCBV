...
namespace HISSMS
{
    public partial class XtraUserControlMauTK373NhomTH : DevExpress.XtraEditors.XtraUserControl
    {
        public XtraUserControlMauTK373NhomTH()
        {
            InitializeComponent();
        }
        ...
        {
            string nameRe = "mau_tk37_NEW_th.mrt";
